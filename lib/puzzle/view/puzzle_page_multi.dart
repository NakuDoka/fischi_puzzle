...
/// from [ThemeBloc].
/// {@endtemplate}
class PuzzlePageMulti extends StatelessWidget {
  /// {@macro puzzle_page}
  const PuzzlePageMulti({Key? key, required this.tiles, required this.isImage}) : super(key: key);
  final int tiles;
  final bool isImage;
...
/// Displays the content for the [PuzzlePageMulti].
/// {@endtemplate}
